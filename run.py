...
for i in range(0, len(mat_files) - step, step):
    ...
    downsampled_source1 = point_cloud1.points[0::downsample_rate] #gledamo svaku stotu tocku
    ...
    reg_p2p = point_2_point(point_cloud1, point_cloud2, trans_init, 0.02, 200)
